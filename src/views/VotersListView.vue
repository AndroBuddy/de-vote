                ...
                <section class="flex flex-col justify-center">
                  <form class="flex flex-col gap-4" @submit.prevent="submit">
                    <div class="flex flex-col gap-2">
                      <label for="email" class="block text-sm font-medium leading-6 text-gray-900 after:content-['*']">
                        Email Address
                      </label>
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      <input id="wallet-id" name="wallet-id" type="text" autocomplete="walletID" placeholder="Wallet ID"
                        required="true"
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      <input id="email" name="email" type="email" autocomplete="email" placeholder="Passkey"
                        required="true"
                        class="block rounded-md border border-slate-300 py-1.5 px-2 placeholder:text-gray-400 placeholder:text-xs focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 sm:leading-6" />
                    </div>
                    <button type="submit"
    ...
    <Transition @enter="onEnter" @leave="onLeave" mode="out-in">
      ...
      <section v-else key="2">
        <div class="border border-black/20 relative overflow-x-auto sm:rounded-lg">
          <table class="w-full table-auto text-left rtl:text-right text-gray-600 dark:text-gray-400">
