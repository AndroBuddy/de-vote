...
<template>
  <main class="flex flex-col items-center lg:items-start w-screen h-screen">
    <LoginHeader />
    <section class="flex flex-col items-center justify-center w-full flex-grow">
      <section class="flex flex-col gap-8">
        ...
        <section class="flex flex-col gap-4">
          <button
            class="flex gap-3 items-center justify-center border-black/20 border p-2 rounded-lg w-96 hover:bg-black/5 transition-colors"
          >
            <IconGoogle />
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  autocomplete="email"
                  required=""
                  class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
