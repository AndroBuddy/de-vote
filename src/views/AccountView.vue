...
<template>
  <section class="flex flex-col px-4 pb-32 lg:pb-12 md:px-14 flex-grow gap-12 mt-5">
    <section class="flex flex-col xl:self-center h-full container">
      <section class="flex flex-col gap-10 transition-transform">
        <section class="flex flex-col sm:flex-row items-center gap-6">
          <img :src="profileStore.userAccount.profileUrl"
        ...
        <form class="flex flex-col gap-6" @submit.prevent="submit">
          <div>
            ...
            <section class="flex gap-4 mt-4" v-if="store.updateFields">
              <div class="flex flex-col">
                <div class="flex items-center justify-between">
                  <label for="password" class="block text-sm font-medium leading-6 text-gray-900 after:content-['*']">
                    Password
                  </label>
                </div>
                <div class="mt-2 relative">
                  <input v-model="store.profilePassword" id="password" name="password" type="password"
              ...
              <button @click="store.setUpdateFields()" type="reset"
            ...
            <button @click="store.setUpdateFields()"
          ...
          <div class="flex flex-col gap-6 lg:w-[40rem]">
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between">
              ...
              <input v-model="store.profileName" :placeholder="profileStore.userAccount.name" id="name" name="name"
                type="name" :disabled="!store.updateFields"
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between">
              ...
              <input v-model="store.profileUserName" :placeholder="profileStore.userAccount.username" id="username"
                name="username" type="username" :disabled="!store.updateFields"
                class="rounded-md border border-slate-300 py-1.5 px-2 placeholder:text-gray-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 invalid:border-red-200 invalid:text-red-600 focus:invalid:border-red-500 focus:invalid:ring-red-500 sm:leading-6 text-sm text-gray-500 sm:w-72" />
            </div>
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between">
              <div class="text-sm text-gray-900">
              ...
              <input v-model="store.profileEmail" :placeholder="profileStore.userAccount.email" id="email" name="email"
                type="email" :disabled="!store.updateFields"
                class="rounded-md border border-slate-300 py-1.5 px-2 placeholder:text-gray-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 invalid:border-red-200 invalid:text-red-600 focus:invalid:border-red-500 focus:invalid:ring-red-500 sm:leading-6 text-sm text-gray-500 sm:w-72" />
            </div>
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between">
              <div class="text-sm text-gray-900">
              ...
              <input v-model="store.profileImg" :placeholder="profileStore.userAccount.profileUrl" id="url" name="url"
                type="url" :disabled="!store.updateFields"
                class="rounded-md border border-slate-300 py-1.5 px-2 placeholder:text-gray-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 invalid:border-red-200 invalid:text-red-600 focus:invalid:border-red-500 focus:invalid:ring-red-500 sm:leading-6 text-sm text-gray-500 sm:w-72" />
            </div>
