...
<template>
  ...
  <RouterView name="FullPage" v-else-if="profileStore.userAccount && profileStore.userAccount.admin == false" />
  <main class="flex min-h-screen md:h-screen bg-[#f5f5f5]"
    v-else-if="profileStore.userAccount && profileStore.userAccount.admin == true">
